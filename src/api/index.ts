...
export const resetPasswordApi = (
  ...
  axiosInstance.post("/v1/authentication/resetPassword", {
    oldPassword,
    newPassword,
    userId,
  });
...
//  properties api
export const getProperties = () => axiosInstance.get("/v1/properties");

// roles api
export const getRoles = () => axiosInstance.get("/v1/roles");
...
export const fetchHolidaysApi = () => axiosInstance.get("/v1/holidays");
...
export const propertyseasonholidaydelete = (id: number) =>
  axiosInstance.delete(
    `/v1/property-season-holidays/property-season-holiday/${id}`
  );
...
export const getBookings = () => axiosInstance.get("/v1/bookings");
...
export const userdetails = () => axiosInstance.get("/v1/users");
...
export const amenitiesapi = () => axiosInstance.get(`/v1/amenities`);
