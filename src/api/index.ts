...
export const updatePropertyDocument = (id: number, formData: FormData) =>
  axiosInstance.patch(
    `/api/propertyDocuments/propertyDocument/${id}`,
    formData,
    {
      headers: { "Content-Type": "multipart/form-data" },
    }
...
export const getPropertySpaceAmenities = (id: number) => {
  return axiosInstance.get(`/property-space-amenities/property/${id}`);
};
