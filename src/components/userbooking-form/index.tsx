...
const ViewBookings: React.FC<BookingProps> = ({
  openEvent,
  handleClose,
  eventId,
}) => {
          ...
          <div className={styles.bookingDetailsContainer}>
            ...
            <div className={styles.bookingInfo}>
              ...
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>
                  {moment(booking.checkinDate).format("MMMM Do YYYY, h:mm a")}
                </span>
              </div>
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>
                  {moment(booking.checkoutDate).format("MMMM Do YYYY, h:mm a")}
                </span>
              </div>
              <div className={styles.detailItem}>
              ...
              <div className={styles.detailItem}>
                ...
                >{`Adults: ${booking.noOfAdults}, Children: ${booking.noOfChildren}`}</span>
              </div>
              <div className={styles.detailItem}>
              ...
              <div className={styles.detailItem}>
                ...
                <span
                  className={styles.detailValue}
                >{`Cleaning: $${booking.cleaningFee}, Pet: $${booking.petFee}`}</span>
              </div>
              <div className={styles.detailItem}>
              ...
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>
                  {booking.isLastMinuteBooking === 1 ? "Yes" : "No"}
                </span>
              </div>
            </div>
          </div>
