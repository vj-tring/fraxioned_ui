...
import { HolidayState, Holiday, FetchHolidayResponse } from "@/store/model";
import { fetchPropertyHoliday, addHoliday, modifyHoliday } from "./action";
...
const holidaySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        fetchPropertyHoliday.fulfilled,
        (state, action: PayloadAction<FetchHolidayResponse>) => {
          state.loading = false;
