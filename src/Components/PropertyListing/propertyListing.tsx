      ...
      <div className="row mt-3">
        <div className="col-md-6">
          <p>
            ...
            consequuntur sint reprehenderit amet libero. Animi alias,
            dignissimos mollitia nesciunt nisi nobis accusamus dolore illo
            laboriosam facere upiditate similique pariatur odio ut voluptatum
            dolore, quae beatae alias ad et, neque , quo optio recusandae
            voluptatibus?
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing it. Maxime neque
            similique, , tenetur doloremque suscipit?
          </p>
        </div>
        <div className="col-md-6">
