...
const PeakSeasonCard: React.FC<PeakSeasonCardProps> = ({ totalNights, nightsStaying, nightsRenting }) => {
  return (
      ...
      <Table bordered className='peaktable'>
        <tbody className='PeakSeason' >
          ...
          <tr>
            ...
            <td className='nights num'>{totalNights - nightsStaying - nightsRenting}</td>
          </tr>
        </tbody>
      </Table>
