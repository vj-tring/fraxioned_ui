...
const OffSeasonCard: React.FC<OffSeasonCardProps> = ({ totalNights, nightsUsed, nightsBooked, holidays }) => {
  return (
    <div className="season-card">
      ...
      <Table bordered>
        <tbody className='offseason'>
          <tr>
            <td className='nights'><strong>TOTAL NIGHTS</strong></td>
          ...
          <tr>
            ...
            <td className='nights num'>{totalNights - nightsUsed - nightsBooked}</td>
          </tr>
        </tbody>
      </Table>
      <Table bordered>
        <tbody  className='offseason'>
          <tr>
            <td className='nights'><strong>TOTAL HOLIDAYS</strong></td>
