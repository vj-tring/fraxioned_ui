        ...
        {showDropdown && (
          <div className="DropItems" onClick={stopPropagation}>
            <div className="list-Items">
              ...
              <button className="Dec-circle" onClick={decreaseAdults}>
                -
              </button>
              <span className="Ad-count">{adultsCount}</span>
              <button className="Inc-circle" onClick={increaseAdults}>
                +
              </button>
            </div>
            ...
            <div className="list-Items">
              ...
              <button className="Dec-circle" onClick={decreaseChildren}>
                -
              </button>
              <span className="Ad-count">{childrenCount}</span>
              <button className="Inc-circle" onClick={increaseChildren}>
                +
              </button>
            </div>
            <hr className="HLine"></hr>
            <div className="list-Items">
              ...
              <button className="Dec-circle" onClick={decreaseInfants}>
                -
              </button>
              <span className="Ad-count">{infantsCount}</span>
              <button className="Inc-circle" onClick={increaseInfants}>
                +
              </button>
            </div>
            <hr className="HLine"></hr>
            <div className="list-Items">
              ...
              <button className="Dec-circle" onClick={decreasePets}>
                -
              </button>
              <span className="Ad-count">{petsCount}</span>
              <button className="Inc-circle" onClick={increasePets}>
                +
              </button>
            </div>
          </div>
