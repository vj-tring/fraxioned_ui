...
describe('ForgetPassword Component', () => {
    ...
    test('displays error message for empty email', async () => {
        ...
        expect(await screen.findByText('Please fill in the Email ID')).toBeInTheDocument()
    })
    ...
    test('displays error message for invalid email', async () => {
        ...
        expect(await screen.findByText('Please enter a valid email ID')).toBeInTheDocument()
    })
    ...
    test('displays error message on API failure', async () => {
        ...
        expect(await screen.findByText('Failed to request password reset. Please try again.')).toBeInTheDocument()
    })
