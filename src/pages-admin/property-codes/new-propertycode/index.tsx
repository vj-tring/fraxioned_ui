...
import { fetchPropertyCodeCategories, createPropertyCodeCategory } from '@/store/slice/property-category/action';
import { createPropertyCode } from '@/store/slice/property-code/action';
