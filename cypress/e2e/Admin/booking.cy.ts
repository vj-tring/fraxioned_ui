describe("Check Booking Functionalities", () => {
    ...
    it("Check Booking",()=>{
        ...
        .get("div:nth-child(3) div:nth-child(2) div:nth-child(1) div:nth-child(4)").contains("07").click()
        .get("#title").type("Booking Title")
        .get("#description").type("Booking Description")
        .get("button").contains("Submit").click().wait(1500)
        .get("div").contains("Booking Title").click()
