describe("Owner Booking Check", () => {
    it("Check all properties and available nights", () => {
        cy.visit("/login")
            ...
            .get(".d-flex.align-items-start.flex-column.card-item").contains("My Home(s)").click({ scrollBehavior: 'center' }).wait(2000)
            ...
            .get("button").contains("2024").click().wait(1500)
            .get("button[class='MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-ulv3xj'] svg").click().wait(1500).get(".BlueHead").contains("Paradise Shores (tenths)")
            .get("button").contains("2024").click().wait(1500)
            .get("button").contains("2025").click().wait(1500)
            .get("button").contains("2026").click().wait(1500)
            .get("button").contains("2024").click().wait(1500)
